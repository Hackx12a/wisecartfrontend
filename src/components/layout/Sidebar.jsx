...
import { Package, Truck, Warehouse, ShoppingCart, Users, Home, UserPlus, PackageSearch, PackageOpen, ChevronDown, ChevronRight, Database } from 'lucide-react';
...
const Sidebar = ({ isOpen, toggle }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-50 h-full bg-gray-900 text-white transform transition-all duration-300 overflow-y-auto
        ...
        <div className="p-6 border-b border-gray-800 flex items-center justify-between">
          ...
          <button
            ...
            className="hidden lg:block p-1.5 rounded-lg hover:bg-gray-800 transition"
