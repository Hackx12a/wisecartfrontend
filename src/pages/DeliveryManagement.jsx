...
const handleGenerateReceiptFull = async (delivery) => {
  try {
    ...
    const receipt = {
      id: fullDelivery.id,
      deliveryReceiptNumber: fullDelivery.deliveryReceiptNumber || '', // Make it editable
      ...
      termsOfPayment: '', // Make it editable
      businessStyle: '',
...
const formatCurrency = (amount) => {
  ...
  if (mode === 'create') {
    ...
    if (delivery.status === 'DELIVERED') {
      alert('Cannot edit a delivery that has already been DELIVERED. Please revert the status first.');
      return;
    }
...
{showReceiptModal && receiptData && (
  <div className="fixed inset-0 bg-black/75 backdrop-blur-sm z-50 flex items-center justify-center p-6">
    <div className="bg-white rounded-2xl max-w-6xl w-full max-h-[95vh] overflow-y-auto shadow-2xl">
      <div className="p-8 border-b border-gray-200 flex justify-between items-center print-text-hidden sticky top-0 bg-white rounded-t-2xl z-10">
        ...
        <div id="delivery-receipt" className="p-8">
          {/* Header Section */}
          <div className="mb-5 pb-4">
            <div className="text-left leading-none space-y-0">
              <div className="text-[34px] font-bold text-gray-900 -mb-0 font-serif tracking-tight company-name print-text-hidden">
                WISECART MERCHANTS CORP.
              </div>
              <div className="text-[18px] text-gray-900 font-medium space-y-[1px] tracking-tight">
                <div className="print-text-hidden">407B 4F Tower One Plaza Magellan The Mactan Newtown</div>
                <div className="print-text-hidden">Mactan 6015 City of Lapu-lapu Cebu, Phils.</div>
                <div className="print-text-hidden">VAT REG. TIN 010-751-561-00000</div>
              </div>
            </div>
            
            <div className="flex justify-between items-baseline mt-2">
              <div className="text-3xl font-bold text-gray-900 tracking-widest receipt-title print-text-hidden">
                DELIVERY RECEIPT
              </div>
              <div className="flex items-center gap-2">
                ...
                <input 
                  type="text" 
                  readOnly
                  value={receiptData.deliveryReceiptNumber}
                  className="text-black-900 text-lg w-40 border-b border-gray-300 px-2 print:border-0 print-text-hidden"
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-4 -mt-4">
            <div>
              <div className="mb-3">
                <div className="flex items-center mb-7">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">DELIVERED TO:</span>
                  <input 
                    type="text" 
                    readOnly 
                    value={`${receiptData.branchName} - ${receiptData.clientName}`}
                    className="text-black-900 text-sm flex-1 border-b border-gray-300 px-2 print:border-0 print:p-0"
                  />
                </div>
              </div>
              <div className="mb-2">
                <div className="flex items-center mb-7">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">ADDRESS:</span>
                  <input 
                    type="text" 
                    readOnly 
              ...
              <div>
                <div className="flex items-center mb-3">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">BUSINESS STYLE:</span>
                  <input 
                    type="text" 
                    readOnly
            ...
            <div>
              <div className="mb-2">
                <div className="flex items-center mb-7">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">DATE:</span>
                  <input 
                    type="text" 
                    readOnly 
              ...
              <div className="mb-2">
                <div className="flex items-center mb-7">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">TIN:</span>
                  <input 
                    type="text" 
                    readOnly 
              ...
              <div>
                <div className="flex items-center gap-8 mb-3">
                  <div className="flex items-center flex-1">
                    <span className="font-bold text-gray-900 text-sm whitespace-nowrap mr-3 print-text-hidden">
                      TERMS OF PAYMENT:
                    </span>
                    <input
                      type="text"
                      ...
                      className="w-full border-b border-gray-300 text-sm text-gray-900 px-2 print:border-0 print:p-0"
                    />
                  </div>
          ...
          {/* Items Table - Data Only */}
          <div className="-mt-3 leading-none">
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-gray-900">
                  <th className="text-left px-3 py-1.5 font-bold text-gray-900 text-xs uppercase tracking-wider print-text-hidden" style={{ width: '10%' }}>
                    Quantity
                  </th>
                  <th className="text-left px-2 py-1.5 font-bold text-gray-900 text-xs uppercase tracking-wider print-text-hidden" style={{ width: '9%' }}>
                    Unit
                  </th>
                  <th className="text-left px-3 py-1.5 font-bold text-gray-900 text-xs uppercase tracking-wider print-text-hidden" style={{ width: '51%' }}>
                    Particulars
                  </th>
                  <th className="text-left px-3 py-1.5 font-bold text-gray-900 text-xs uppercase tracking-wider print-text-hidden" style={{ width: '30%' }}>
                    <input
                      type="text"
                      readOnly
                      value={receiptData.extraHeader || 'EXTRA'}
                      className="w-full bg-transparent font-bold text-xs uppercase px-0 py-0.5 border-none"
                    />
                  </th>
                </tr>
              </thead>
                    ...
                    <tr key={i} className="align-top">
                      ...
                      <td className="px-3 py-1">
                        <input
                          ...
                          readOnly
                          value={item.extra || ''}
                          className="w-full bg-transparent border-none text-xs px-0 py-0.5"
                        />
                      </td>
                    </tr>
                  ))
          ...
          <div className="text-xs text-black-900 mt-1 font-bold print-text-hidden">
          ...
          <div className="grid grid-cols-2 gap-8 mt-6">
            <div>
              <div className="mb-4">
                <div className="flex items-center mb-1">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">Prepared by:</span>
                  <input 
                    type="text" 
                    readOnly
            ...
            <div>
              <div className="mb-4">
                <div className="flex items-center mb-1">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">Received by:</span>
                  <span className="text-black-900 text-sm flex-1 border-b border-gray-300">&nbsp;</span>
                </div>
                <div className="text-xs text-black-900 mt-1 ml-32 font-bold print-text-hidden">
                  Customer Signature over Printed Name
                </div>
              </div>
              <div className="mt-6">
                <div className="flex items-center mb-1">
                  <span className="font-bold text-gray-900 text-sm w-32 print-text-hidden">Date Received:</span>
                  <span className="text-black-900 text-sm flex-1 border-b border-gray-300">&nbsp;</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 pt-4 text-center">
            <div className="text-gray-900 mb-2 text-[10.9px] print-text-hidden">
            ...
            <div className="text-xs font-bold text-gray-900 italic print-text-hidden">
              *THIS DOCUMENT IS NOT VALID FOR CLAIM INPUT TAX*
            </div>
          </div>
        </div>
      
      <div className="p-8 border-t border-gray-200 flex justify-end gap-4 print-text-hidden sticky bottom-0 bg-white rounded-b-2xl">
        <button 
          onClick={() => window.print()} 
              ...
              <div className="p-8">
                <div className="grid grid-cols-2 gap-8 mb-8">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 mb-1"><strong>Receipt #:</strong> {selectedDelivery.deliveryReceiptNumber}</p>
                    <p className="text-sm text-gray-600 mb-1"><strong>Date:</strong> {new Date(selectedDelivery.date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
                    {selectedDelivery.purchaseOrderNumber && (
                      <p className="text-sm text-gray-600 mb-1"><strong>PO #:</strong> {selectedDelivery.purchaseOrderNumber}</p>
                    )}
                    {selectedDelivery.transmittal && (
                      <p className="text-sm text-gray-600 mb-1"><strong>Transmittal:</strong> {selectedDelivery.transmittal}</p>
                    )}
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-700 mb-2">Branch & Client</h3>
                    <p className="text-sm text-gray-600 mb-1"><strong>Branch:</strong> {selectedDelivery.branch.branchName}</p>
                    <p className="text-sm text-gray-600 mb-1"><strong>Branch Code:</strong> {selectedDelivery.branch.branchCode}</p>
                    <p className="text-sm text-gray-600 mb-1"><strong>Client:</strong> {selectedDelivery.client.clientName}</p>
                    <p className="text-sm text-gray-600"><strong>TIN:</strong> {selectedDelivery.client.tin || 'N/A'}</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-700 mb-2">Status</h3>
                    <span className={`px-4 py-2 inline-flex text-sm leading-5 font-semibold rounded-full ${getStatusColor(selectedDelivery.status)}`}>
                      {selectedDelivery.customStatus || selectedDelivery.status}
                    </span>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-semibold text-gray-700 mb-2">Prepared By</h3>
                    <p className="text-sm text-gray-600">{selectedDelivery.preparedBy || 'N/A'}</p>
                  </div>
                </div>
                ...
                {selectedDelivery.remarks && (
                  <div className="mb-8 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    ...
                    <p className="text-sm text-gray-600">{selectedDelivery.remarks}</p>
                  </div>
                )}
                    ...
                    <table className="w-full">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-700">Warehouse</th>
                          <th className="px-6 py-4 text-left text-sm font-medium text-gray-700">Particular</th>
                        </tr>
                      </thead>
                        ...
                        {selectedDelivery?.items && selectedDelivery.items.length > 0 ? (
                          selectedDelivery.items.map((item, i) => (
                            <tr key={item.id || i} className="hover:bg-gray-50 transition">
                              ...
                              <td className="px-6 py-4 text-sm text-gray-900">
                                {item.warehouse ? item.warehouse.warehouseName : '—'}
                              </td>
                              <td className="px-6 py-4 text-sm text-gray-900">
